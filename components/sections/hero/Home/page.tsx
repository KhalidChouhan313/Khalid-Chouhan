...
const HomeContent = () => {
  return (
    ...
    >
      <div className="w-full flex items-center justify-center mb-4 mt-[5%]">
        <h1 className="text-5xl md:text-6xl  font-black uppercase tracking-tight text-white select-none">
          Developer
        </h1>
      </div>
